...
(function () {
  ...
  document.querySelectorAll('.code-block').forEach(function (b) {
    ...
    var title = b.querySelector('.code-title');
     ...
     btn.addEventListener('click', function () {
      ...
      try {
        if (navigator.clipboard && navigator.clipboard.writeText) {
          navigator.clipboard.writeText(code).then(flash, function () {
  ...
  /* ---------- 6ج) الاختبارات التفاعلية ---------- */
  document.querySelectorAll('.quiz-q').forEach(function (q) {
    q.addEventListener('click', function () {
      var a = q.nextElementSibling;
      if (a && a.classList.contains('quiz-a')) {
